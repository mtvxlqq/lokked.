...
export const router = createHashRouter([
  {
    ...
    children: [
      ...
      {
        // Дуэль — тоже поверх всего: ход идёт на весь экран, а между ходами
        // устройство передают из рук в руки, и навигация под пальцем
        // соседа ни к чему. KaTeX тот же, что и в прогоне.
        path: "duel",
        lazy: async () => {
          const { Duel } = await import("@/routes/Duel");
